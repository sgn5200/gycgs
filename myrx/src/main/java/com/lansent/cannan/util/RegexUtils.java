...
public final class RegexUtils {
    ...
    public static boolean isCode(final CharSequence input) {
        return isMatch(RegexConstants.REGEX_MOBILE_SMS, input);
    }
    ...
    public static boolean isAgentCode(final CharSequence input){
         return isMatch(RegexConstants.AGENT,input);
    }
